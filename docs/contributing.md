...
Contributions are welcome. `go-ruby-dry-struct/dry-struct` is built to a small set of
...
The library is in [`github.com/go-ruby-dry-struct/dry-struct`](https://github.com/go-ruby-dry-struct/dry-struct).
This documentation site is in [`github.com/go-ruby-dry-struct/docs`](https://github.com/go-ruby-dry-struct/docs).
