...
The public API lives at the module root (`github.com/go-ruby-dry-struct/dry-struct`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `dry-struct`, while the surface follows
...
```go
import "github.com/go-ruby-dry-struct/dry-struct"
```
...
- **[pkg.go.dev/github.com/go-ruby-dry-struct/dry-struct](https://pkg.go.dev/github.com/go-ruby-dry-struct/dry-struct)**

The module's [README](https://github.com/go-ruby-dry-struct/dry-struct#readme) carries worked
