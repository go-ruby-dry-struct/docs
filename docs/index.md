# go-ruby-dry-struct documentation

**Pure-Go, MRI-faithful Ruby dry-struct (no cgo)**

`go-ruby-dry-struct/dry-struct` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `dry-struct`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-dry-struct/dry-struct`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `dry-struct`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-dry-struct/dry-struct
```
...
| Repo | What it is |
| --- | --- |
| [`dry-struct`](https://github.com/go-ruby-dry-struct/dry-struct) | the library — Ruby's `dry-struct` in pure Go |
| [`docs`](https://github.com/go-ruby-dry-struct/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-dry-struct.github.io`](https://github.com/go-ruby-dry-struct/go-ruby-dry-struct.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-dry-struct/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-dry-struct/dry-struct](https://github.com/go-ruby-dry-struct/dry-struct).
